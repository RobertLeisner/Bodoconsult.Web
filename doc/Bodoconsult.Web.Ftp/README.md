...
Bodoconsult.Web.Ftp library simplifies the access to FTP servers via SSH. 
...
### Put a local directory as main directory to the remote server
...
### Put a local directory as subdirectory to the remote server
